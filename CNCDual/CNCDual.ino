...
#define STEPS_PER_MMY        (108.7238095238095) // EM-258 nema17 varilla roscada 8mm
#define STEPS_PER_MMZ        (108.7238095238095) // unsued
#define MAX_FEEDRATE         (12500000)
...
void line(float newx, float newy, float newz) {
  ...
  a[2].delta = (newz - pz) * STEPS_PER_MMZ;
...
void motor_setup() {
  ...
  motors[0].limit_switch_pin = 6;

  //axis Y - TOWER
  motors[1].step_pin = 8;
  motors[1].dir_pin = 9;
  motors[1].enable_pin = 10;
  motors[1].limit_switch_pin = 7;

  //axis Z - servo?
  motors[2].step_pin = 11;
  motors[2].dir_pin = 12;
  motors[2].enable_pin = 1;
  motors[2].limit_switch_pin = 2;
